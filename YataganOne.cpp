#include "StdAfx.h"
#include "YataganOne.h"
#include "Projectile.h"
#include "WeaponSystem.h"
#include "IVehicleSystem.h"
#include "Actor.h"

bool CYataganOne::Init(IGameObject * pGameObject)
{
   SetGameObject(pGameObject);
   return true;
}

void CYataganOne::PostInit(IGameObject * pGameObject)
{
   ...
   GetEntity()->LoadGeometry(0, "Objects/Weapons/Kilic/YataganOne.cgf");
...
void CYataganOne::Update(SEntityUpdateContext& ctx, int slot)
{

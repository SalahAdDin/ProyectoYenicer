...
//Yeniceri's Project Objects

//Weapons
#include "YenicerisProjectFiles/Weapons/Kilic/YataganOne.h"
...
#include "Environment/BoundingContainer.h"
...
#define REGISTER_VEHICLEOBJECT(name, obj) \
	...
	//Weapons
	REGISTER_GAME_OBJECT(pFramework, YataganOne, "");
	...
	REGISTER_GAME_OBJECT(pFramework, TowerSearchLight, "Scripts/Entities/Environment/TowerSearchLight.lua");
	REGISTER_GAME_OBJECT(pFramework, DoorPanel, "Scripts/Entities/Environment/DoorPanel.lua");
	REGISTER_GAME_OBJECT(pFramework, BoundingContainer, "Scripts/Entities/Others/BoundingContainer.lua");
